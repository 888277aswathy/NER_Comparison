...
def fetch_news_article(api_key):
    url = f'https://newsapi.org/v2/everything?q=tesla&from=2024-07-03&sortBy=publishedAt&apiKey=36d71b4b4eb946f398cba86a3b2648d5'
...
api_key = '36d71b4b4eb946f398cba86a3b2648d5'  # Example API key
...
nltk.download('words')
nltk.download('averaged_perceptron_tagger')  # Additional NLTK data
